################################################################################
##### Script to parse engineering courses in the University of Toronto     #####
##### @ Junhyeok Hong                                                      #####
...
with open('../data/engineering.html') as data_file:
    with open('../output/engineering.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
        ...
        for index, line in enumerate(data_file):
            ...
            if '<div class="no-break views-row"><div class="views-field views-field-title"><span class="field-content"><br /><h3>' in line:
                ...
                course_name = parse_line2.split('</h3></span></div>')[0]
                if ('&amp;' in course_name):
                ...
                # Parse 4 - Details
                if 'class="views-field views-field-field-desc"' in parse_line2:
                    parse_line4 = parse_line3.split(
                        '<div class="views-field views-field-field-desc"><div class="field-content"><p>')[1]
