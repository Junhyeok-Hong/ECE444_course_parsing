################################################################################
##### Script to parse daniels courses in the University of Toronto         #####
##### @ Junhyeok Hong                                                      #####
...
with open('../data/daniels.html') as data_file:
    with open('../output/daniels.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
