################################################################################
##### Script to parse music courses in the University of Toronto           #####
##### @ Junhyeok Hong                                                      #####
...
with open('../data/music.html') as data_file:
    with open('../output/music.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
        ...
        for index, line in enumerate(data_file):
            ...
            if '<div class="no-break views-row"><div class="views-field views-field-field-course-title"><div class="field-content"><br /><h3>' in line:
                ...
                if 'class="views-label views-label-field-fixed-credit"' in parse_line2:
                    parse_line3 = parse_line2.split(
                        'Fixed Credit: </strong><span class="field-content">')[1]
